...
export function ProductPageClient({ params }: ProductPageProps) {
        ...
        <TabsContent value="description" className="pt-4">
          <div className="text-muted-foreground">
            ...
            <p>
              ...
              características y su brillante acidez. Este café es perfecto para métodos de preparación pour-over que
              resaltan su complejo perfil de sabor.
            </p>
          </div>
        </TabsContent>
