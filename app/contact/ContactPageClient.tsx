...
export default function ContactPageClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(
          "Error",
          error instanceof Error ? error.message : "Hubo un problema al enviar tu mensaje. Por favor intenta de nuevo.",
          "error"
      )
    } finally {
      ...
      <div className="flex flex-col min-h-screen">
        ...
        {toast && (
            <div className="fixed top-4 right-4 z-50 animate-pulse">
              <div className={`flex items-center p-4 rounded-lg shadow-lg border max-w-md ${
                  toast.type === "success"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            onChange={handleChange}
                            className={`min-h-[150px] max-h-[280px] border-primary-200 dark:border-dark-border ${errors.message ? "border-red-500" : ""}`}
                            disabled={isSubmitting}
                        />
